...
test("test multi devise add", 1, function()
{
	...
	throws(function() {var m3=MoneyOps.add(m1,m2)
...
test("test simple soustraction", 2, function()
    {
        var m1=new money(3,"EUR");
        var m2=new money(2,"EUR");
        var m3=new money(1,"EUR");

        ok(m3.equals(MoneyOps.soustraction(m1,m2)),"3e = 1e - 2e");
        deepEqual(m3,MoneyOps.soustraction(m1,m2),"3e = 1e - 2e deepEqual");
    }
);



test("test v1-v2(v1 < b2) ", 1, function()
    {
        var m1=new money(1,"EUR");
        var m2=new money(2,"EUR");
        throws(function() {var m3=MoneyOps.soustraction(m1,m2)
        },SoustractionIncompatibleExc, "Soustraction exception");
    }
);